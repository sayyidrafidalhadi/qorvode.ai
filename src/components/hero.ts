...
function initRoleToggle() {
  ...
  const devElements = document.querySelectorAll<HTMLElement>('.btn-dev, .hero-desc-dev');
  const vocalElements = document.querySelectorAll<HTMLElement>('.btn-vocal, .hero-desc-vocal');
