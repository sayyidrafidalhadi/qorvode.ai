...
import { Play, Pause, ChevronDown, ChevronUp, Music, Calendar, Clock, Instagram, Github, Heart, Headphones } from 'lucide-react';
...
const TrackCard = ({ release, isActive, onPlay }) => {
...
const SpotifyPlayer = ({ activeRelease }) => {
...
const Discography = ({ releases, activeRelease, onPlay }) => {
  return (
